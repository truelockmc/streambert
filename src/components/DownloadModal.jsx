          ...
          <div style={{ padding: 24 }}>
            <div style={{ fontSize:14, color:'var(--text2)', marginBottom:20, lineHeight:1.6 }}>
              {settingPath
                ...
                : <><span style={{ color:'var(--red)', fontWeight:600 }}>No download folder set.</span><br />Choose where to save downloaded videos:</>
              }
            </div>
            ...
            <div style={{ display:'flex', gap:10 }}>
              <button
                ...
                onClick={() => { storage.set('downloadPath', downloadPath.trim()); setSettingPath(false) }}
              >
                Confirm
              </button>
              ...
              <div className="download-instructions">
                ...
                {checking && (
                  <div className="download-checking">
                    <div className="spinner" style={{ width:16, height:16, borderWidth:2 }} /> Checking …
                  </div>
                )}
                {!checking && downloader && !downloader.exists && downloaderFolder && (
                  <div className="download-error">
                    No binary found. Make sure <code>_internal</code> and the binary are inside the chosen folder.
                  </div>
                )}
              </div>
            )}
              ...
              <div className="download-ready">
                ...
                <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:14, flexWrap:'wrap' }}>
                  ...
                  <button className="btn btn-ghost" style={{ fontSize:12, padding:'4px 10px' }}
                    onClick={() => setSettingPath(true)}>Change</button>
                </div>
